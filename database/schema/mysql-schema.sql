...
CREATE TABLE `jobs` (
  ...
  `Task_desc` text COLLATE utf8mb3_unicode_ci NOT NULL,
  `Resp_person` bigint NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `tasks` (
  ...
  `status` enum('open','review','progress','close') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT 'open',
  PRIMARY KEY (`id`),
  KEY `name` (`name`),
  CONSTRAINT `user_assigned` FOREIGN KEY (`name`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
