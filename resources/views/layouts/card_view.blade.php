                                                                        ...
                                                                        <div class="dropdown">
                                                                            ...
                                                                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton{{ $task->id }}">
                                                                                <form action="{{ route('tasks.duplicate', $task->id) }}" method="POST" style="display: inline;">
                                                                                    ...
                                                                                    <a href="javascript:void(0);" class="dropdown-item" onclick="if (confirm('Are you sure you want to duplicate this task?')) this.closest('form').submit();">
                                                                                        Duplicate
                                                                                    </a>
                                                                                </form>
                                                                                ...
                                                                                <form id="delete-task-form-{{ $task->id }}" action="{{ route('tasks.destroy', $task->id) }}" method="POST" style="display: inline;">
                                                                                        @csrf
                                                                                        @method('DELETE')
                                                                                        <a href="javascript:void(0);" class="dropdown-item" onclick="confirmDelete({{ $task->id }})">
                                                                                           Delete
                                                                                        </a>
                                                                                </form>
                                                                            </div>
